...
import com.google.developer.bugmaster.customViews.DangerLevelView;
...
class InsectListAdapter extends RecyclerView.Adapter<InsectListAdapter.InsectHolder> {

    private List<Insect> insects = new ArrayList<>();

    public InsectListAdapter() {
    }

    public InsectListAdapter(List<Insect> insects) {
